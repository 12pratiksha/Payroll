...
export class AllModulesService {
  ...
  constructor(private http: HttpClient, public router: Router) {
    // this.sseSubject = new Subject<MessageEvent>();
  ...
  async ngOnInit() {
    // try {
    //     // const data: any = await this.http.get('/assets/config.json').toPromise();
    //     // this.path = data;
  ...
  //   try {
  //     const data: any = await this.http.get('/assets/json/jsonfile.json').toPromise();
  //     this.path = data;
  //     // environment.apiEndpoint = this.path;
  //     console.log(this.path);
  //   } catch (error) {
