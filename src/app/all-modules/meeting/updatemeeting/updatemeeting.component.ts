...
this.showOtherContainer='nview'
  ...
  submit(){
    ...
    console.log(this.agenda[i].id)
    this.meetingDesc1.push({'description':farray[i].description,'meetingTaskAsignEmp':mettingTaskAsignEmp,"meetingMomId":this.agenda[i].id})
