...
@Component({
  selector: 'app-coff-application',
  templateUrl: './coff-application.component.html',
  styleUrls: ['./coff-application.component.css']
})
export class CoffApplicationComponent implements OnInit {
  @ViewChild('myInput')
