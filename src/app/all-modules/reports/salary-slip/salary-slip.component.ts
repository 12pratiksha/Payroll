...
export class SalarySlipComponent implements OnInit {
  ...
  getEmployee(){
    ...
    if(this.usertype!='Admin'){
      ...
      if(pf.searchBy==""){
        ...
        let url = "getSalarySlips?usertype="+this.usertype+"&year="+pf.year+"&month="+pf.month+"&state="+pf.state+"&category="+pf.category+"&subCategory="+"&status="+pf.status+"&employeeId="+pf.searchBy+"&department="+pf.department+"&subDepartment="+pf.subDepartment+"&branch="+branchId+"&grade="+pf.grade+"&designation="+pf.designation
  ...
  if(flag==0){
  if(pf.searchBy && branchStatus=='true' && pf.branch==''){
    let emp=pf.searchBy.split(" ");
    let emply=this.employees.filter((emply)=>
    (emply.employeeCode == emp[0]))
    let url = "getSalarySlips?usertype="+this.usertype+"&year="+pf.year+"&month="+pf.month+"&state="+pf.state+"&category="+pf.category+"&subCategory="+"&status="+pf.status+"&employeeId="+emply[0].employeeId+"&department="+pf.department+"&subDepartment="+pf.subDepartment+"&branch="+branchId+"&grade="+pf.grade+"&designation="+pf.designation
    this._service.get(url).subscribe((data) => {
      if(data.data.length==0){
        this.tableData=[];
        this.dataSource = new MatTableDataSource();
  ...
  else if(pf.searchBy && branchStatus=='true' && pf.branch!=''){
      let emp=pf.searchBy.split(" ");
      let emply=this.employees.filter((emply)=>
      (emply.employeeCode == emp[0]))
      console.log(emply)
      console.log(pf)
      let url = "getSalarySlips?usertype="+this.usertype+"&year="+pf.year+"&month="+pf.month+"&state="+pf.state+"&category="+pf.category+"&subCategory="+"&status="+pf.status+"&employeeId="+emply[0].employeeId+"&department="+pf.department+"&subDepartment="+pf.subDepartment+"&branch="+pf.branch+"&grade="+pf.grade+"&designation="+pf.designation
      this._service.get(url).subscribe((data) => {
      if(data.data.length==0){
        this.tableData=[];
        this.dataSource = new MatTableDataSource();
  ...
  else if(pf.searchBy && branchStatus=='false' ){
    let emp=pf.searchBy.split(" ");
   let emply=this.employees.filter((emply)=>
   (emply.employeeCode == emp[0]))
   console.log(emply)
   ...
   this._service.get(url).subscribe((data) => {
  ...
  else if(pf.searchBy==undefined && branchStatus=='true' && pf.branch==''){
      let url = "getSalarySlips?usertype="+this.usertype+"&year="+pf.year+"&month="+pf.month+"&state="+pf.state+"&category="+pf.category+"&subCategory="+"&status="+pf.status+"&employeeId="+""+"&department="+pf.department+"&subDepartment="+pf.subDepartment+"&branch="+branchId+"&grade="+pf.grade+"&designation="+pf.designation
      this._service.get(url).subscribe((data) => {
      if(data.data.length==0){
        this.tableData=[];
        this.dataSource = new MatTableDataSource();
      ...
      let url = "getSalarySlips?usertype="+this.usertype+"&year="+pf.year+"&month="+pf.month+"&state="+pf.state+"&category="+pf.category+"&subCategory="+"&status="+pf.status+"&employeeId="+""+"&department="+pf.department+"&subDepartment="+pf.subDepartment+"&branch="+pf.branch+"&grade="+pf.grade+"&designation="+pf.designation
      this._service.get(url).subscribe((data) => {
          if(data.data.length==0){
            this.tableData=[];
            this.dataSource = new MatTableDataSource();
 ...
 // cthis._service.get(url).subscribe((data)=>{
 // this.tableData = data.data
 // this.tableLen = data.length
 // this.dataSource = new MatTableDataSource<any>(this.tableData);
...
let form=this.payrollForm.value
  ...
  // let url='employees/search?employeeName='+`${form.searchBy}`
