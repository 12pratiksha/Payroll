...
export class AdminDashboardComponent implements OnInit {
  ...
  ngOnInit() {
  this.branchStatus=localStorage.getItem('branchStatus')
  ...
  dashboardDatas(){
    ...
    url='admindashboard/getdashboardvalues?branch='+this.branchId+'&department='
    } 
    else{
    url='admindashboard/getdashboardvalues?branch=&department='
    }

    let data = {}
    this._service.getDetails(data, url).subscribe((res)=>{
...
getMale (){
  let url='';
  if(this.branchStatus=='true'){
     url='CountTotalMaleEmployeeWise?branch='+this.branchId+'&department='
  }
  else{
      url='CountTotalMaleEmployeeWise?branch=&department='
  }
  this._service.getDetails({}, url).subscribe((res)=>{
...
getFemale(){
  let url='';
  if(this.branchStatus=='true'){
    url= 'CountTotalFeMaleEmployeeWise?branch='+this.branchId+'&department='
  }
  else{
    url= 'CountTotalFeMaleEmployeeWise?branch=&department=';
  }
  this._service.getDetails({},url).subscribe((res)=>{
