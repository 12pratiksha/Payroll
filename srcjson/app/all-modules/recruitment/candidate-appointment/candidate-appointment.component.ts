...
@Component({
  selector: 'app-candidate-appointment',
  templateUrl: './candidate-appointment.component.html',
  styleUrls: ['./candidate-appointment.component.css']
})
export class CandidateAppointmentComponent implements OnInit {
