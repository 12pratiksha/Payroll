...
@Component({
  selector: 'app-import-daily-attendance',
  templateUrl: './import-daily-attendance.component.html',
  styleUrls: ['./import-daily-attendance.component.css']
})
export class ImportDailyAttendanceComponent implements OnInit {
  @ViewChild('myInput')
  myInputVariable: ElementRef;
  fileName= 'importDailyAttendance.xlsx';
  file: any;
  sheet: any;
...
this.importAttendanceForm=this._fb.group({
  ...
  exportexcel(): void
  {
    ...
    let url = this.host+"/assets/Excle/ImportDailyAttendance.xlsx";
 ...
 let formData = new FormData();
    ...
    this._service.uploadFile(formData, 'ImplortDailyAttendenceMaster/getsheets').subscribe((res)=>{
      this.sheet =res;
...
Swal.fire({
  ...
  didOpen: () => {
    Swal.showLoading()
     ...
     this._service.uploadFile(formData, 'ImplortDailyAttendenceMaster/uploadfileexcel').subscribe((res)=>{
