...
// let url = "getAttendanceProcess?fromDate="+`${fromDate}`+"&toDate="+`${toDate}`+"&state="+`${form.state}`+"&subCategory&status="+`${form.status}`+"&employeeNo="+`${form.id}`+"&category="+`${form.category}`+"&department="+`${form.department}`+"&branch="+`${form.branch}`
   let url = "getAttendanceProcess?fromDate="+`${fromDate}`+"&toDate="+`${toDate}`+"&state="+`${form.state}`+"&category="+`${form.category}`+"&subCategory=&status="+status+"&employeeNo="+`${form.id}`+"&department="+`${form.department}`+"&branch="+`${form.branch}`
...
let status=form.status;
   ...
   //  let url = "getBulkAttendenceList?fromDate="+`${fromDate}`+"&toDate="+`${toDate}`+"&state="+`${form.state}`+"&subCategory&status="+`${form.status}`+"&employeeNo&category"+`${form.category}`+"&department"
   // let url = "getAttendanceProcess?fromDate="+`${fromDate}`+"&toDate="+`${toDate}`+"&state="+`${form.state}`+"&subCategory&status="+`${form.status}`+"&employeeNo="+`${form.id}`+"&category="+`${form.category}`+"&department="+`${form.department}`+"&branch="+`${form.branch}`
      let url = "getAttendenceExtrationList?fromDate="+`${fromDate}`+"&toDate="+`${toDate}`+"&state="+`${form.state}`+"&category="+`${form.category}`+"&subCategory=&status="+status+"&employeeNo="+`${form.id}`+"&department="+`${form.department}`+"&branch="+`${form.branch}`
