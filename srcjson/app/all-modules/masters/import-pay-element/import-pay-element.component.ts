...
@Component({
  selector: 'app-import-pay-element',
  templateUrl: './import-pay-element.component.html',
  styleUrls: ['./import-pay-element.component.css']
})
export class ImportPayElementComponent implements OnInit {
 @ViewChild('myInput')
...
if (this.file.type=="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"){
 ...
 let formData = new FormData();
    ...
    this._service.uploadFile(formData, 'PayElementMaster_master/getsheets').subscribe((res)=>{
      this.sheet =res;
...
Swal.fire({
  ...
  didOpen: () => {
    Swal.showLoading()
     ...
     this._service.uploadFile(formData, 'PayElementMaster_master/uploadfileexcel').subscribe((res)=>{
