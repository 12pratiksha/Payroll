...
@Component({
  selector: 'app-assign-role-excel',
  templateUrl: './assign-role-excel.component.html',
  styleUrls: ['./assign-role-excel.component.css']
})
export class AssignRoleExcelComponent implements OnInit {
  @ViewChild('myInput')
...
this.importAttendanceForm=this._fb.group({
 ...
 let formData = new FormData();
    ...
    this._service.uploadFile(formData, 'AttendanceStatusList_master/getsheets').subscribe((res)=>{
      this.sheet =res;
...
Swal.fire({
  ...
  didOpen: () => {
    Swal.showLoading()
     ...
     this._service.uploadFile(formData, 'AttendanceStatusReport_master/uploadfileexcel').subscribe((res)=>{
