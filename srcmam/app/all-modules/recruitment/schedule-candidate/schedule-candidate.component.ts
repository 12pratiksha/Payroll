...
let url='getByNoOfRounds/'+item.roundId
  ...
  // let url = "employee_master/getemployee/"+`${interviewer}`
  // this.service.get(url).subscribe((res)=>{
...
// this.fArray().at(i).get('interview').setValue(this.interviewer);


  
  //this.fArray().get('interview').setValue(this.interviewer)
...
//   this.service.get(url).subscribe((res)=>{
//     console.log(res)
//     // let url1='getByApplicantCandiateListId/'+res.applicantCandiateId
//     // this.service.get(url).subscribe((res)=>{
//     //   console.log(res)
