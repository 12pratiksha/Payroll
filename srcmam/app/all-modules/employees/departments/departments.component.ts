...
getDepartment(){
 ...
 // this.departments = res
  data.forEach(element => {
    ...
    this.departments_display.push({"departmentId":element.departmentId,"departmentName":element.departmentName,"state":resultstate[0].stateName,"branch":resultbranch[0].branchName})
  })
 

  this.departments=this.departments_display
  console.log(this.departments_display)
