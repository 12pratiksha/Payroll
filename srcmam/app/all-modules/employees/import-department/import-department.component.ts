...
@Component({
  ...
  styleUrls: ['./import-department.component.css']
})
...
if (this.file.type=="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"){
 ...
 let formData = new FormData();
    ...
    this._service.uploadFile(formData, 'Department_master/getsheets').subscribe((res)=>{
      this.sheet =res;
...
Swal.fire({
  ...
  didOpen: () => {
    Swal.showLoading()
     ...
     this._service.uploadFile(formData, 'Department_master/uploadfileexcel').subscribe((res)=>{
